...
@WebServlet("/assign/delete")
public class AssignDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private AssignService service = new AssignService();
       
  public AssignDeleteServlet() {
    super();
  }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = service.deleteAssign(assignNo);
		...
		if (result > 0) {
			...
			jsonObj.put("resultMsg", "과제가 삭제되었습니다.");
		}
