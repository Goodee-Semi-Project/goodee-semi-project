...
<c:choose>
	<c:when test="${ loginAccount.author eq 1 }">
		...
		<a style="margin-right: 10px; font-weight: normal; font-size: 15px;" href="<c:url value='/myCourse/enrollList' />">수강신청 관리</a>
	</c:when>
	
	<c:when test="${ loginAccount.author eq 2 }">
		<a style="margin-right: 10px; font-weight: normal; font-size: 15px;" href="<c:url value='/myCourse/list' />">내 교육과정</a>
		<a style="margin-right: 10px; font-weight: normal; font-size: 15px;" href="<c:url value='/myCourse/enrollList' />">신청한 교육과정</a>
		<a style="margin-right: 10px; font-weight: normal; font-size: 15px;" href="<c:url value='/myCourse/likeList' />">찜한 교육과정</a>
