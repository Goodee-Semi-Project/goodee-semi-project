...
<body>
	...
	<!-- 로그인 기능 병합 후 두 줄 삭제 -->
	<input type="button" onclick='location.href="${request.contextPath()}/qnaBoard/list/update?no=${question.questNo}"'
       value="수정">
...
<%-- 			<input type="button" id="btn_update" onclick='location.href="<c:url value='/qnaBoard/list/update?no=${question.questNo}'/>"' value="수정"> --%>
<%-- 			<input type="button" id="btn_delete" value="삭제">				 --%>
<%-- 		</c:if> --%>
<%-- 	</c:if> --%>
	<script>
