	    ...
	    <div class="row">
	      <div class="col-lg-12 pt-5 pt-lg-0">
	        <div class="about-content">
	          ...
	          <h3 class="font-weight-bold">🌿 사랑과 존중으로 완성되는 교육</h3>
	          <p>저희 훈련소는 단순히 기술을 가르치는 공간이 아니라, 
	          반려견과 보호자가 서로를 이해하고 존중하는 소중한 시간을 만들어가는 곳입니다. 
	          강압적인 방법이 아닌 긍정 강화 교육을 원칙으로 삼아, 
	          반려견이 자발적으로 참여하고 즐겁게 배울 수 있도록 돕습니다. 
	          다양한 연령과 성격의 반려견에게 알맞은 맞춤형 커리큘럼을 통해 자신감을 키우고, 
	          보호자님과의 유대감을 돈독히 합니다.</p>
	          <h3 class="font-weight-bold">🐕‍🦺 다양한 단계별 훈련 프로그램</h3>
	          <p>어린 강아지를 위한 사회화 과정부터 성견의 문제 행동 교정, 
	          보호자와의 협력 강화를 위한 고급 훈련까지 단계별로 체계적인 프로그램이 마련되어 있습니다. 
	          각 수업은 훈련사와 보호자가 긴밀히 소통하며 진행되며, 
	          일상에서도 자연스럽게 실천할 수 있는 방법을 함께 배웁니다.</p>
	          <h3 class="font-weight-bold">🌟 함께 성장하는 즐거움</h3>
	          <p>훈련의 목적은 명령 수행만이 아니라, 
	          반려견이 스스로 생각하고 긍정적인 선택을 할 수 있는 힘을 기르는 데 있습니다. 
	          보호자님과 반려견이 함께 배우며 성장하는 모든 순간이 저희에게는 귀중한 경험입니다. 
	          언제나 열린 마음으로 여러분의 이야기를 듣고, 함께 최선의 길을 찾아가겠습니다.</p>
	        </div>
	      </div>
	    </div>
	  </div>
